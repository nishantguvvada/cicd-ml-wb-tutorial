...
def get_baseline_run(entity='nishant-guvvada-rackspace-technology', project='my-report-project', tag='baseline'):
...
def compare_runs(entity='nishant-guvvada-rackspace-technology',
                 project='cicd-ml',
                 tag='baseline',
                 run_id=None):
